...
This project was developed as part of the **2nd Year, 1st Semester Digital Electronics and Logic Circuit Laboratory (ECE 2104) Open Ended Project**. 

The system is a hardware-based 3-digit random number generator (000–999) designed to function as a Digital Lottery Machine. While software-based generators are common, this project focuses on the educational value of realizing such a system entirely through discrete digital ICs without any microcontroller. It demonstrates core concepts of digital electronics including oscillators, counters, and display drivers in a compact, cost-effective implementation.
